...
import secd_staplus_client.model.ext.entity_list
from frost_sta_client.query.query import Query as STAQuery
...
class Query(STAQuery):
    ...
    def service(self, service):
        if service is None:
            ...
            return
        if not isinstance(service, secd_staplus_client.service.staplusservice.STAplusService):
    ...
    def list(self, callback=None, step_size=None):
        ...
        entity_list = secd_staplus_client.utils.transform_json_to_entity_list(json_response, self.entity_class)
    ...
    def item(self, callback=None, step_size=None):
        ...
        try:
            ...
            raise ValueError('Cannot find json in http response')
        entity = secd_staplus_client.utils.transform_json_to_entity(json_response, self.entity_class)
