...
from secd_staplus_client.dao.observation import ObservationDao, SubjectDao, ObjectDao
from secd_staplus_client.model import observation_group, relation
...
class Observation(observation.Observation):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        attributes = {'_id': None, '_phenomenon_time': None, '_result': None, '_result_time': None,
                      '_result_quality': None, '_valid_time': None, '_parameters': {},
                      '_datastream': None, '_multi_datastream': None,
                      '_observation_groups': None, '_subjects': None, '_objects': None,
                      '_feature_of_interest': None, '_self_link': '', '_service': None}
